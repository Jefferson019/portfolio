...
- Histórico de projetos estratégicos apresentados diretamente à **alta gestão (diretores e presidência)**.  
...
- ✅ **Classificação de eventos médicos em tempo real** com Spark Streaming + Kafka.  
- ✅ **Clusterização e NLP** para análise de termos médicos e padrões comportamentais.  
- ✅ **Deploy e versionamento de modelos em produção** com MLflow Model Serving no Azure Databricks.  
- ✅ **Agentes de IA Generativa** para automação de decisões em saúde (pagamentos, extração de features e inferência de textos).  
...
- **Visualização de Dados:** Power BI, Streamlit, Matplotlib, Seaborn, Excel Avançado  
- **Automação & APIs:** Flask, PowerShell, RPA  
- **Metodologias:** CRISP-DM, DataOps, COSO, Scrum  
